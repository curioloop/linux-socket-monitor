package com.curioloop.linux.socket.probe.utils;

import java.util.Locale;

/**
 *
 * @see <a href="https://github.com/netty/netty/blob/4.1/common/src/main/java/io/netty/util/internal/PlatformDependent.java">PlatformDependent.java</a>
 */
